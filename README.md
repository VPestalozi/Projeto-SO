...
* **Ambiente:** É recomendado o uso de um **ambiente virtual** ou sistema operacional configurado para execução de Java para garantir que o escalonamento das threads ocorra conforme o esperado.
...
1.  **Clone o repositório:**
    ```bash
    git clone (https://github.com/VPestalozi/Projeto-SO/Projeto 1 - C012.git)
    ```
...
---
*Este repositório serve como registro de aprendizado acadêmico sobre a gestão de processos e threads em nível de software.*
